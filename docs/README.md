...
O projeto mantém o CRUD, as validações e as consultas das aulas anteriores, usando Spring Boot, PostgreSQL e Flyway. A collection de testes está na pasta `postman`, e as alterações estão na branch `feature` para a entrega por pull request.
